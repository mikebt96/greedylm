...
class ResourceManager:
    ...
    async def consume(self, chunk_x: int, chunk_y: int, agent_did: str, 
                        resources: dict, purpose: str) -> bool:
    ...
    async def calculate_class_update(self, agent_did: str):
        async with AsyncSessionLocal() as db:
            ...
            new_class = "lower"
            if weighted_avg > 0.8: new_class = "elite"
            elif weighted_avg > 0.4: new_class = "middle"
            elif weighted_avg < 0.15: new_class = "outcast"
