...
const BIOME_CONFIG: Record<string, { color: string; count: number; size: number; speed: number }> = {
    snow:     { color: '#e3f2fd', count: 600, size: 0.08, speed: 0.4 },
    desert:   { color: '#ffe0b2', count: 300, size: 0.05, speed: 0.2 },
    forest:   { color: '#c8e6c9', count: 200, size: 0.04, speed: 0.15 },
    volcanic: { color: '#ff8a65', count: 150, size: 0.06, speed: 0.5 },
    nexus:    { color: '#b3e5fc', count: 100, size: 0.03, speed: 0.1 },
    plains:   { color: '#fff9c4', count: 80,  size: 0.03, speed: 0.08 },
    ocean:    { color: '#80deea', count: 250, size: 0.04, speed: 0.3 },
};
