      ...
      <div className="max-w-5xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-5 gap-12 items-start">
        ...
        <section aria-labelledby="form-heading" className="md:col-span-3">
          ...
          <div className="space-y-2 mb-5">
            <button type="button" onClick={() => { window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/v1/auth/google`; }}
            ...
            <button type="button" onClick={() => { window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/v1/auth/github`; }}
            ...
            <button type="button" onClick={() => { window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/v1/auth/apple`; }}
